...
try {
  console.log('%cCombined Notifications v7.2.2 → Starting definePanel()', 'color:#39FF14; font-weight:bold');
  definePanel();
  console.log('%cCombined Notifications v7.2.2 → Successfully registered', 'color:#39FF14; font-weight:bold');
} catch (e) {
  ...
  const errorHTML = `
    <div style="position:fixed;top:50%;left:50%;transform:translate(-50%,-50%);background:#1e2535;color:#fc8181;padding:30px 40px;border-radius:16px;border:3px solid #fc8181;z-index:999999;font-family:sans-serif;max-width:90%;text-align:center;box-shadow:0 20px 60px rgba(0,0,0,0.8);">
      ...
      <p style="margin:8px 0">Version 7.2.2</p>
      ...
      <div class="panel-root">
        <div class="dialog">
          ...
          <div class="dialog-footer">
            <span class="version-stamp">pja v7.2.2</span>
